...
\begin{enumerate}
\item Data
The Washington, D.C., bikeshare data set consists of station-level reports of the number of bikes and empty slots available every minute, as well as weather data observed on an hourly basis. We augmented this data with weather data recorded on an hourly basis.
